...
| 注意力头数     | $n\_h$          | 32       | 40        | 52        | 64        |
| 每头维度      | $d\_k = d/n\_h$ | 128      | 128       | 128       | 128       |
| FFN 中间维度  | $d\_{ff}$       | 11008    | 13824     | 17920     | 22016     |
| 上下文长度     | $T\_{max}$      | 2048     | 2048      | 2048      | 2048      |
| 词表大小      | $V$             | 32000    | 32000     | 32000     | 32000     |
| GQA KV 头数 | $n\_{kv}$       | 32 (MHA) | 40 (MHA)  | 52 (MHA)  | 64 (MHA)  |
...
| **$d\_{ff}$** | $4d$                        | $\frac{8}{3}d$（取整）        | 保持与 2 层 FFN 相同的参数量  |
